...
set rc [catch {
  ...
  open_checkpoint /home/krek07/Documents/PUF/PUF20191/project_1/project_1.runs/impl_1/system_wrapper.dcp
...
set rc [catch {
  ...
  set_property XPM_LIBRARIES {XPM_CDC XPM_MEMORY} [current_project]
  add_files /home/krek07/Documents/PUF/BD/system/ip/system_microblaze_0_0/data/mb_bootloop_le.elf
  set_property SCOPED_TO_REF system [get_files -all /home/krek07/Documents/PUF/BD/system/ip/system_microblaze_0_0/data/mb_bootloop_le.elf]
  set_property SCOPED_TO_CELLS microblaze_0 [get_files -all /home/krek07/Documents/PUF/BD/system/ip/system_microblaze_0_0/data/mb_bootloop_le.elf]
